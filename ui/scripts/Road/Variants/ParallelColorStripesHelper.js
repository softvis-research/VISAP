            ...
            if (laneSide === "right") {
                ...
                switch (direction) {
                    ...
                    case "south": {
                        ...
                        else if (directionOfPredecessor === "west" && directionOfSuccessor === "west") newZ = originalPosition.z + 0.3;
            ...
            if (laneSide === "right") {
                switch (direction) {
                    ...
                    case "south": {
                        ...
                        else if (directionOfPredecessor === "west" && directionOfSuccessor === "west") newDepth = originalDepth - 0.8;
                ...
                switch (direction) {
                    ...
                    case "east": {
                        if (directionOfPredecessor === "north" && directionOfSuccessor === "north") newWidth = originalWidth - 0.6;
